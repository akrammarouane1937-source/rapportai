...
router.post("/revise", async (req: Request, res: Response) => {
  ...
  // Cost abuse guard — caps revisions per section per day even during FREE_LAUNCH,
  // so a single user can't loop revisions on an expensive section and burn the budget.
