...
export const PLAN_LIMITS: Record<PlanId, PlanLimit> = {
  ...
  basique: { pages: Infinity, revisions: 8,        label: "Basique",   labelShort: "Basique",   priceMad: 147, priceUsd: 15, anchorMad: 350,  stripePriceId: "price_1ThvTn003Ts2AXbaKWJA2vd8" },
