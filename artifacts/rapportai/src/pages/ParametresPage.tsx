...
import { Save, Check, User, GraduationCap, BookOpen, Building, Trash2 } from "lucide-react";
      ...
      <main className="flex-1 p-8 min-w-0">
        <div className="max-w-2xl mx-auto">
          <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.35 }}>
            ...
            <div className="bg-purple-50 rounded-2xl border border-purple-100 p-5 mb-5">
            ...
            <div className="bg-red-50 rounded-2xl border border-red-100 p-5 flex items-center justify-between gap-4">
              <div>
                <p className="text-sm text-red-700 font-medium mb-1">Supprimer le rapport</p>
                <p className="text-xs text-red-500">
                  Efface définitivement ce rapport et son contenu. Exporte-le d'abord si tu veux le garder.
                </p>
              </div>
              <Button
                onClick={handleDelete}
                variant="ghost"
                className="shrink-0 flex items-center gap-2 text-red-600 hover:text-red-700 hover:bg-red-100 border border-red-200"
              >
